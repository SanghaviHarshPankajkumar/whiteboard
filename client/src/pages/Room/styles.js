...
export default makeStyles(()=> ({
    ...
    radioGroup: { display: 'flex', flexDirection: 'row', justifyItems: 'space-between', width: '100%', justifyContent: 'center', marginLeft: '10%' },
    colorPicker: { paddingLeft: '1%', marginTop: '4px' },
